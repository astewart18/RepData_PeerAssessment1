...
```
Note that this plot has poor resolution, even when I play around with the dpi setting. Is this an issue with knitr? This alternative looks better.
```{r}
png(filename="interval_data_plot.png")
plot(interval_data,type="l")
dev.off()
```
This is the result
![alt text]("./interval_data_plot.png" "Linked plot")
